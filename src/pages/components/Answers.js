...
class Answers extends Component {
  ...
  counter = () => {
    const tempo = setInterval(() => {
      this.setState((prevState) => ({
        ...
        const { timer, wasClicked, intervalFunc } = this.state;
  ...
  render() {
    ...
    const { difficulty } = questionsState[index];
...
const mapStateToProps = ({ player, questionsReducer: { results: { results } } }) => ({
  playerState: player,
...
Answers.propTypes = {
  ...
  questionsState: PropTypes.objectOf(PropTypes.any).isRequired,
};
